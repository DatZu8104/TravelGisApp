...
const HomeMain: React.FC = () => {
  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen className="light-content" ref={contentRef}>
        <IonButton 
          fill='clear'
          className="scroll-to-top-btn"
          onClick={() => contentRef.current?.scrollToTop(500)} // 500ms mượt
        >
          🔝
        </IonButton>
        {/* Hero Section */}
        ...
        <div className="navbar">
          <IonButton fill="clear" className="nav-button"
            onClick={() => {
              const section = document.getElementById("section-promotion");
          ...
          <IonButton fill="clear" className="nav-button"
            onClick={() => {
              const section = document.getElementById("section-tours");
              if (section) section.scrollIntoView({ behavior: "smooth" });
            }}
          >
            Tours
        ...
        {/* Section: Khuyến mãi */}
        <section className="promotion" id="section-promotion">
